"""Reverse-grip row — MoveBank: 2) Pull / Row variation.

Decomposed from the base row per grip: palms facing front (underhand/
supinated grip).
"""
...
EXERCISE = Exercise(
    ...
    mover_position_end="hanging_palms_front",
